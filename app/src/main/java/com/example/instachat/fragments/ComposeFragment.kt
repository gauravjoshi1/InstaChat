...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPreview = view.findViewById(R.id.ivPictures)
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(requireContext(), "Please add a picture to the post!", Toast.LENGTH_SHORT).show()
            }
        }



        view.findViewById<ImageButton>(R.id.btnTakePictures).setOnClickListener {
            // Launch Camera App
            onLaunchCamera()
        }
    }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground{exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Congrats, post saved to the server", Toast.LENGTH_SHORT).show()
